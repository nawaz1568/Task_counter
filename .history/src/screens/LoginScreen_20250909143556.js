...
export default function LoginScreen({ navigation }) {
  ...
  // Navigate to JSON posts screen
  const goToJSONPosts = () => {
    // Pass some dummy interval values if needed
  ...
  // Navigate to Dummy API posts screen
  const goToDummyPosts = () => {
